...
namespace MTA.Migrations
{
    ...
    [Migration("20241216081313_Updatedates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MTA.Models.Alert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MTA.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MTA.Models.ProjectMissions+ProjectMission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id", "ProjectId", "MissionId");
            ...
            modelBuilder.Entity("MTA.Models.Project", b =>
                {
                    b.HasOne("MTA.Models.Department", "Department")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MTA.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
